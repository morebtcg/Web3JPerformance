...
public class Ok extends Contract {
    ...
    public RemoteFunctionCall<TransactionReceipt> trans(BigInteger num) {
    ...
    public static List<TransEventEventResponse> getTransEventEvents(
            TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList =
                staticExtractEventParametersWithLog(TRANSEVENT_EVENT, transactionReceipt);
    ...
    public static TransEventEventResponse getTransEventEventFromLog(Log log) {
        EventValuesWithLog eventValues = staticExtractEventParametersWithLog(TRANSEVENT_EVENT, log);
        TransEventEventResponse typedResponse = new TransEventEventResponse();
    ...
    public Flowable<TransEventEventResponse> transEventEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(log -> getTransEventEventFromLog(log));
    }
    ...
    public static class TransEventEventResponse extends BaseEventResponse {
